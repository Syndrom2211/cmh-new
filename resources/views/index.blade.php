    ...
    @section('content')
                    ...
                    <div class="product-card p-3 border rounded shadow-sm h-100">
                        ...
                        <div class="p-4">
                            ...
                            <ul class="features-list ps-2 mb-2">
                                ...
                                <li class="mb-1 text-secondary"><small><Portal></Portal>rofesional &amp; MIRIP</small></li>
        ...
        <section class="portfolio-section">
            <div class="container position-relative">
                ...
                <p class="text-center">Tekan Cursor dan Geser Kiri Kanan untuk Melihat Portofolio Kami!</p>
                        ...
                        @foreach ($portfolios as $item)
                            <div class="swiper-slide">
                                <div class="portfolio-card">
                                    <h3 class="portfolio-title">Judul : {{ strtoupper($item->name) }}</h3>
                                    <p class="portfolio-genre">Genre Musik : {{ $item->genre }}</p>
