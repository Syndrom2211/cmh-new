...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-md w-full space-y-8 p-8 shadow-lg rounded-2xl">
        ...
        <div class="bg-gray-100 rounded-lg p-6">
            <h3 class="text-xl font-semibold mb-4"><font color="#fff">{{ $order->nama }}</font></h3>
    ...
    <div class="max-w-md w-full space-y-8 p-8 shadow-lg rounded-2xl">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-white-600">
                <font color="#fff">
                {{ app()->getLocale() === 'id' ? 'Silahkan isi rincian pesanan Anda sebelum melanjutkan ke pembayaran.' : 'Please fill in your order details before proceeding to payment.' }}
                </font>
            </p>
        </div>
        ...
        {{-- Rincian Produk --}}
        <div class="bg-gray-100 rounded-lg p-6">
            <h3 class="text-xl font-semibold mb-4"><font color="#fff">{{ $product['name'] ?? 'Produk Tidak Diketahui' }}</font></h3>
            <p class="text-gray-700 mb-2">
        ...
        <form action="{{ route('payment.process') }}" method="POST" class="mt-6 space-y-4">
            ...
            {{-- Tombol Submit --}}
            <div class="space-y-2">
                <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none btn-success">
